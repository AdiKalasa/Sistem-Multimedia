...
function showFeature(title, video, desc) {
    ...
    <p style="margin-top:20px; font-size:1.1rem; line-height:1.8; color:#dce3ea;">${desc}</p>
...
function showImage(title) {
    ...
    <p style="color:#b0c4de; margin-top:10px;">Ganti dengan foto aktual Anda di sini</p>
